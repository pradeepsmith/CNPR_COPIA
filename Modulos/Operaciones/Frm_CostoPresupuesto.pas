...
type
  TfrmCostoPresupuesto = class(TForm)
    ...
    cxGridCotizacionesDBTableView2: TcxGridDBTableView;
    cxGridCotizacionesDBTableView2Column3: TcxGridDBColumn;
    cxGridCotizacionesDBTableView2Column1: TcxGridDBColumn;
    cxGridCotizacionesDBTableView2Column2: TcxGridDBColumn;
    cxGridLevel2: TcxGridLevel;
    cxGridCotizacionesLevel2: TcxGridLevel;
...
begin
  ...
  begin
    ...
    FiltrarDataSet(Zcotizacion,'sNumeroOrden',[zOrdenesTrabajo.FieldByName('sNumeroOrden').AsString,zOrdenesTrabajo.FieldByName('sContrato').AsString]);
    Zcotizacion.Open;
    AsignarSQL(zCotizacionDet,'op_cotizacion_presupuesto_detalle',pUpdate);
    FiltrarDataSet(zCotizacionDet,'Id,Cotizacion',[-1,-1]);
    zCotizacionDet.Open;
